...
const ServicesCard = ({ title, description, image }) => {
  return (
    <div className="group relative max-w-80 bg-[#f1f0fe] flex flex-col space-y-4 p-5 items-center justify-center  rounded-3xl cursor-pointer">
      <div className="absolute bg-[#7a6ad8] rounded-full p-8 -right-16 -top-16  ">
        <img
          className="transform group-hover:-translate-y-2 duration-200"
          src={image}
          alt=""
        />
      </div>
